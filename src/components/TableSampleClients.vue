...
<template>
  ...
  <CardBoxModal v-model="isModalDangerActive" title="Please confirm" button="danger" has-cancel :user-id="userIdToDelete"
    @close="userIdToDelete = null">
    <p>คุณต้องการลบข้อมูลผู้ใช้งาน <b>ID : {{ userIdToDelete }}</b> ? </p>
  </CardBoxModal>
      ...
      <tr v-for="client in itemsPaginated" :key="client.id">
        ...
        <td class="before:hidden lg:w-1 whitespace-nowrap">
          <BaseButtons type="justify-start lg:justify-end" no-wrap>
            ...
            <BaseButton color="danger" :icon="mdiTrashCan" small @click="openModalDelete(client.id)" />
          </BaseButtons>
        </td>
      </tr>
    </tbody>
